%
%{
        This is an example to show how to use the BatchLeastSquares (BLS)
        ...
        input and output vectors with the BLS algorithm to estimate the
        parameters
%}
...
%% Estimation using BatchLeastSquares function
%comment what you don't want to estimate
% [ theta, Gz_estm ] = BatchLeastSquares( u, y, 1, 1, 1, Ts); % 1st order estimation
[ theta, Gz_estm ] = BatchLeastSquares( u, y, 2, 1, 1, Ts); % 2nd order estimation
